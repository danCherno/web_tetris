...
var score = 0; // console.log(gameGrid); // testing
...
function () {
  function Block(color, posInPiece, isImportant) {
    ...
    function fall() {
      ...
      this.position[1]--;
      gameGrid[this.position[0]][this.position[1]] = this.id; //todo: update for css grid
    }
...
document.getElementById("gameLayout").innerHTML = renderGridToHTML(gameGrid); // clearLine(5); //testing
// render main